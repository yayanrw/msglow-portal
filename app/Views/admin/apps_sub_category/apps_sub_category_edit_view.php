                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="apps_sub_category_pid" class="form-control" name="apps_sub_category_pid" placeholder="App sub category pid" value="<?= $apps_sub_category['apps_sub_category_pid']; ?>" hidden required>
                                    <input type="text" id="apps_sub_category_title" class="form-control text-black" name="apps_sub_category_title" placeholder="App title" value="<?= $apps_sub_category['apps_sub_category_title']; ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                                ...
                                <div class="col-sm-3">
                                    <select class="select2 form-select text-black" id="apps_pid" name="apps_pid">
                                        ...
                                        <?php foreach ($apps as $key) { ?>
                                            <option value="<?= $key['apps_pid']; ?>" <?= $key['apps_pid'] == $apps_sub_category['apps_pid'] ? 'selected' : null ?>><?= $key['apps_name']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
