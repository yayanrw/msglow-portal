    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body p-3">
                <form class="form form-horizontal" action="<?= base_url('admin/apps-documentation/update'); ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="apps_document_pid" class="form-control" name="apps_document_pid" placeholder="Document pid" value="<?= $apps_documentation['apps_document_pid']; ?>" required hidden>
                                    <input type="text" id="apps_document_title" class="form-control" name="apps_document_title" placeholder="Document title" value="<?= $apps_documentation['apps_document_title']; ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
