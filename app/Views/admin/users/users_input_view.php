    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body p-3">
                <form id="frm_users" name="frm_users" class="form form-horizontal" action="<?= base_url('admin/users/insert'); ?>" method="post">
                    <?= csrf_field(); ?>
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="users_email" class="form-control text-black" name="users_email" placeholder="User Email" value="<?= old('users_email'); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
