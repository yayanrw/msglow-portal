    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body p-3">
                <form class="form form-horizontal" action="<?= base_url('admin/sop-category/update'); ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-6">
                                    <input id="sop_category_banner_img" name="sop_category_banner_img" class="form-control" type="file">
                                </div>
                            </div>
                        </div>
                        <div class="row pt-2">
