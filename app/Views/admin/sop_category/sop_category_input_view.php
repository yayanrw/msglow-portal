    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body p-3">
                <form class="form form-horizontal" action="<?= base_url('admin/sop-category/insert'); ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="sop_category_title" class="form-control text-black" name="sop_category_title" placeholder="Category title" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
