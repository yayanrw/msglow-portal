...
class SopDocumentsModel extends Model
{
    ...
    protected $allowedFields = ['sop_category_pid', 'sop_documents_title', 'sop_documents_desc', 'sop_documents_file', 'sop_documents_banner_img', 'is_active', 'created_by', 'updated_at', 'updated_by'];
